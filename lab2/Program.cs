...
class Program
{
    ...
    private class Configuration
    {
        ...
        public bool RunBothMethods { get; set; } = true;
    }
        ...
        switch (methodName.ToLower())
        {
            ...
            default:
                throw new ArgumentException(
                    $"Invalid method '{methodName}'. Use 'bfs' or 'dfs'"
                );
        }
    }
    ...
    private static void ExecuteSolveCommand(Configuration config)
    {
        ...
        if (config.RunBothMethods || config.Method == NQueensSolver.SolveMethod.BFS)
        {
            // Create BFS solver
        ...
        if (config.RunBothMethods || config.Method == NQueensSolver.SolveMethod.DFS)
        {
            // Create DFS solver
    ...
    private static void PrintUsage()
    {
        ...
        sb.AppendLine("        -s, --solution-mode: Specify solution finding mode:");
